...
# - tracking
# - apps
# - app_3d_rec_framework
# - app_modeler
# - app_cloud_composer
# - app_in_hand_scanner
# - app_point_cloud_editor
# - people
# - simulation
#
...
macro(find_boost)
  ...
  find_package(Boost 1.40.0 ${QUIET_} COMPONENTS system filesystem thread date_time iostreams mpi serialization)
...
macro(find_openni)
  if(NOT OPENNI_ROOT AND ("ON" STREQUAL "ON"))
    set(OPENNI_INCLUDE_DIRS_HINT "/usr/include/openni")
...
elseif(EXISTS "${PCL_DIR}/include/pcl/pcl_config.h")
  ...
  set(PCL_SOURCES_TREE "/home/taylor/src/pcl")
...
set(pcl_all_components  common kdtree octree search io sample_consensus filters 2d features keypoints geometry ml segmentation visualization outofcore stereo surface registration recognition tracking apps app_3d_rec_framework app_modeler app_cloud_composer app_in_hand_scanner app_point_cloud_editor people simulation )
...
set(pcl_apps_int_dep common geometry io filters sample_consensus segmentation visualization kdtree features surface octree registration keypoints tracking search recognition ml stereo )
set(pcl_app_3d_rec_framework_int_dep common geometry io filters sample_consensus segmentation visualization kdtree features surface octree registration keypoints tracking search recognition ml )
set(pcl_app_modeler_int_dep common geometry io filters sample_consensus segmentation visualization kdtree features surface octree registration keypoints tracking search apps )
...
set(pcl_app_3d_rec_framework_ext_dep vtk openni )
set(pcl_app_modeler_ext_dep vtk )
set(pcl_simulation_ext_dep opengl glew )


set(pcl_io_opt_dep openni vtk libusb-1.0 )
